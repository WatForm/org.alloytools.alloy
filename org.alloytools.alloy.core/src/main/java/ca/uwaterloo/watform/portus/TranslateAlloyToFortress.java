...
public final class TranslateAlloyToFortress implements CommandRunner {
    ...
    private void writeSmtlibToFile(A4Reporter reporter, A4Options options, TranslationContext context)
            throws IOException {
        // Output the SMT-LIB generated by Fortress to a temporary file
        File smtlibFile = File.createTempFile("tmp", ".smtlib", new File(options.tempDirectory));
        ...
        reporter.resultCNF(smtlibFile.getAbsolutePath());
    }
