 ...
 */
final class AntiMergePreprocessor implements Preprocessor {
    ...
    public AlloyProblem preprocess(AlloyProblem problem) {
        ...
        PreprocessVisitor visitor = new PreprocessVisitor(sortPolicy);
    ...
    private static final class PreprocessVisitor extends NaturalRecursion.AlloyASTMapper {
        ...
        public PreprocessVisitor(SortPolicy sortPolicy) {
            super(sortPolicy);
        }
        ...
        public Expr visit(ExprQt x) throws Err {
            ...
            for (Decl decl : x.decls) {
                ...
                // case where required: "all a, b: univ | a in A and b in B" requires a in A, b in B simultaneously
